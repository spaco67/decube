      ...
      >
        <div className="flex flex-col h-full">
          <div className="px-4 py-6 bg-teal-600 dark:bg-teal-700">
            ...
            <p className="text-teal-100">{user?.role.charAt(0).toUpperCase() + user?.role.slice(1)} Dashboard</p>
          </div>
            ...
            <div className="space-y-2">
              <Link 
                ...
                className={`flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-teal-50 dark:hover:bg-gray-700 rounded-lg transition-colors ${
                  location.pathname === '/admin' ? 'bg-teal-50 dark:bg-gray-700 text-teal-600 dark:text-teal-400' : ''
                }`}
              >
              ...
              {user?.role === 'waiter' && (
                <>
                  <Link 
                    to="/waiter/new-order" 
                    className={`flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-teal-50 dark:hover:bg-gray-700 rounded-lg transition-colors ${
                      location.pathname === '/waiter/new-order' ? 'bg-teal-50 dark:bg-gray-700 text-teal-600 dark:text-teal-400' : ''
                    }`}
                  >
                  ...
                  <Link 
                    to="/waiter/orders" 
                    className={`flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-teal-50 dark:hover:bg-gray-700 rounded-lg transition-colors ${
                      location.pathname === '/waiter/orders' ? 'bg-teal-50 dark:bg-gray-700 text-teal-600 dark:text-teal-400' : ''
                    }`}
                  >
              ...
              {(user?.role === 'barman' || user?.role === 'admin') && (
                <Link 
                  to="/bar-orders" 
                  className={`flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-teal-50 dark:hover:bg-gray-700 rounded-lg transition-colors ${
                    location.pathname === '/bar-orders' ? 'bg-teal-50 dark:bg-gray-700 text-teal-600 dark:text-teal-400' : ''
                  }`}
                >
              ...
              {(user?.role === 'kitchen' || user?.role === 'admin') && (
                <Link 
                  to="/kitchen-orders" 
                  className={`flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-teal-50 dark:hover:bg-gray-700 rounded-lg transition-colors ${
                    location.pathname === '/kitchen-orders' ? 'bg-teal-50 dark:bg-gray-700 text-teal-600 dark:text-teal-400' : ''
                  }`}
                >
              ...
              {user?.role === 'admin' && (
                <div className="space-y-2 pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <Link 
                    to="/admin/staff" 
                    className={`flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-teal-50 dark:hover:bg-gray-700 rounded-lg transition-colors ${
                      location.pathname === '/admin/staff' ? 'bg-teal-50 dark:bg-gray-700 text-teal-600 dark:text-teal-400' : ''
                    }`}
                  >
                  ...
                  <Link 
                    to="/admin/tables" 
                    className={`flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-teal-50 dark:hover:bg-gray-700 rounded-lg transition-colors ${
                      location.pathname === '/admin/tables' ? 'bg-teal-50 dark:bg-gray-700 text-teal-600 dark:text-teal-400' : ''
                    }`}
                  >
                  ...
                  <Link 
                    to="/admin/inventory" 
                    className={`flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-teal-50 dark:hover:bg-gray-700 rounded-lg transition-colors ${
                      location.pathname === '/admin/inventory' ? 'bg-teal-50 dark:bg-gray-700 text-teal-600 dark:text-teal-400' : ''
                    }`}
                  >
                  ...
                  <Link 
                    to="/admin/reports" 
                    className={`flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-teal-50 dark:hover:bg-gray-700 rounded-lg transition-colors ${
                      location.pathname === '/admin/reports' ? 'bg-teal-50 dark:bg-gray-700 text-teal-600 dark:text-teal-400' : ''
                    }`}
                  >
                  ...
                  <Link 
                    to="/admin/settings" 
                    className={`flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-teal-50 dark:hover:bg-gray-700 rounded-lg transition-colors ${
                      location.pathname === '/admin/settings' ? 'bg-teal-50 dark:bg-gray-700 text-teal-600 dark:text-teal-400' : ''
                    }`}
                  >
                  ...
                  <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-lg shadow-lg py-2 z-50">
                    ...
                    <div className="max-h-64 overflow-y-auto">
                      <div className="px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700">
                        <p className="text-sm text-gray-800 dark:text-gray-200">New order for table 5</p>
                        <p className="text-xs text-gray-500 dark:text-gray-400">2 minutes ago</p>
                      </div>
                      <div className="px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700">
                        <p className="text-sm text-gray-800 dark:text-gray-200">Order #124 is ready for pickup</p>
                        <p className="text-xs text-gray-500 dark:text-gray-400">10 minutes ago</p>
                      </div>
                    </div>
                    <div className="px-4 py-2 border-t border-gray-200 dark:border-gray-700">
                      <a href="#" className="text-xs text-teal-600 dark:text-teal-400 hover:underline">View all notifications</a>
                    </div>
                  </div>
                )}
              </div>
